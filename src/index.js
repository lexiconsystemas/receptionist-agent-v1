...
app.post('/webhook/retell/begin-call', (req, res) => {
  try {
    // RetellAI inbound_dynamic_variables_webhook_url body structure:
    // { event: "call_inbound", event_timestamp: ..., call_inbound: { from_number, to_number, ... } }
    const fromNumber = req.body?.call_inbound?.from_number || null;
